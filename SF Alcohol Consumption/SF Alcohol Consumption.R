...
setwd(".../SF Alcohol Consumption")
nm <- list.files(path=".../SF Alcohol Consumption/PDF")

Team1 <- read_document(file=".../Team1.txt")
Team2 <- read_document(file=".../Team 2.txt")
Team3 <- read_document(file=".../team3.txt")
Team4 <- read_document(file=".../team4.txt")
Team5 <- read_document(file=".../Team5.txt")
Team7 <- read_document(file=".../Team 7.txt")
Team8 <- read_document(file=".../Team 8.txt")
Team9 <- read_document(file=".../Team9.txt")
Team10 <- read_document(file=".../Team10.txt")
Team11 <- read_document(file=".../Team11.txt")
Team12 <- read_document(file=".../Team12.txt")
...
afinnV6 <- frequencies_tokens_nostopV6 %>%
  ...
  group_by(index=line) %>% #using integer division to define larger sections of text
